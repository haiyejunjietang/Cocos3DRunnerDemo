  ...
  return {
    ...
    execute: function () {
      ...
      _export("ForeverManager", ForeverManager = (_dec = ccclass('ForeverManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class ForeverManager extends Component {
        ...
        recycleBlock() {
          const playerZ = this.player.position.z; // 遍历所有子节点（方块）

          for (let i = this.node.children.length - 1; i >= 0; i--) {
            const block = this.node.children[i]; // 当方块超出玩家后方指定距离时，销毁或回收（这里用销毁，简单高效）
...
//# sourceMappingURL=324b274d44fa0c9824928a8da2c0245335c73c16.js.map